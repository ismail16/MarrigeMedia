    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('author.images.create') }}" class="float-right btn btn-sm btn-primary"> <i
                            ...
                            <tbody>
                                @foreach($UserProfileImages as $UserProfileImage)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('author.images.edit', $UserProfileImage->id)}}"
                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                            <form action="{{route('author.images.destroy', $UserProfileImage->id)}}" method="post"
