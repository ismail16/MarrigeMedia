            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="">
                        ...
                        @endif
                        <form action="{{route('author.basic-info.update', $user->id)}}" method="post" enctype="multipart/form-data" class="p-3">
                            @method('PUT')
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group mb-1 col-md-6">
                                    <label class="mb-0">Insert New password (If you want to Update Password)</label>
