				...
				<form class="" action="{{ route('search_groom_bride')}}" method="post" enctype="multipart/form-data">
					...
					<div class="row _bg-body-green mt-1 mb-1 p-2 search_option_div">
						<div class="col-sm-6 col-md-2 col-lg-2 search_option">
							<h6 class="mb-1 form-label">Looking</h6>
						...
						<div class="col-sm-6 col-md-3 col-lg-3 search_option">
							<h6 class="mb-1 form-label">Age (MIN - MAX)</h6>
						...
						<div class="col-sm-6 col-md-4 col-lg-2 search_option">
							<h6 class="mb-1 form-label">Marital Status</h6>
						...
						<div class="col-sm-6 col-md-4 col-lg-2 search_option">
							<h6 class="mb-1 form-label">Relegion</h6>
						...
						<div class="col-sm-6 col-md-4 col-lg-2 search_option">
							<h6 class="mb-1 form-label">Profession</h6>
