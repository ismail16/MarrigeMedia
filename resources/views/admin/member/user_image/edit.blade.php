                    ...
                    <div class="col-md-12">
                        <div class="card mt-2 bg-light-green ">
                            <div class="p-4 m-4">
                                ...
                                @endif
                                <form action="/admin/user-info/{{$UserProfileImage->user_id}}/images/{{$UserProfileImage->id}}" method="post" enctype="multipart/form-data" class="p-3 bg-body-green">
                                    @method('PUT')
                                    @csrf
                                    <input type="hidden" name="image_id" value="{{ $UserProfileImage->id }}">
                                    <input type="hidden" name="user_id" value="{{ $UserProfileImage->user_id }}">
                                    <div class="form-row">
